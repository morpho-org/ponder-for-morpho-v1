...
writeDefinition(definitionsDir, "camp.js");
writeDefinition(esmDefinitionsDir, "camp.js");

// Add exports to entrypoints
patchIndex(indexTs, `export { camp } from './definitions/camp.js';`);
patchIndex(esmIndexJs, `export { camp } from './definitions/camp.js';`);
