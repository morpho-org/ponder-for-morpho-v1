...
writeDefinition(definitionsDir, 'tac.js');
writeDefinition(esmDefinitionsDir, 'tac.js');

// Add exports to entrypoints
patchIndex(indexTs, `export { tac } from './definitions/tac.js';`);
patchIndex(esmIndexJs, `export { tac } from './definitions/tac.js';`);
